...
\node [circle, minimum height=0.75cm, draw] (v6) at (6.5,-2.5) {$b$};
\node [circle, minimum height=0.75cm, draw] (v7) at (6.5,-5) {$c$};
\node [circle, minimum height=0.75cm, draw] (v3) at (10.5,0) {$x$};
\node [circle, minimum height=0.75cm, draw] (v4) at (10.5,-2.5) {$y$};
...
\node [circle, minimum height=0.75cm, draw] (v8) at (15,-1) {$x$};
\node [circle, minimum height=0.75cm, draw] (v12) at (13,-2.5) {$b$};
\node [circle, minimum height=0.75cm, draw] (v11) at (13.5,-5) {$c$};
\node [circle, minimum height=0.75cm, draw] (v10) at (16.5,-5) {$ay$};
\node [circle, minimum height=0.75cm, draw] (v9) at (17,-2.5) {$z$};
\draw  (v8) edge (v9);
\draw  (v9) edge (v10);
\draw  (v10) edge (v11);
\draw  (v11) edge (v12);
