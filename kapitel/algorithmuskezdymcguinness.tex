...
\begin{enumerate}[resume]
  \item \label{item:algorithmus13} Planaritätstest:
                                   \begin{enumerate}
                                     ...
                                     \item $Z_i$ enthält ein \kf-Homöomorph: Stopp
                                     \item $Z_i$ enthält ein \kdd-Homöomorph: Weiter zu Schritt \ref{item:algorithmus14}
                                   \end{enumerate}
  ...
  \item \label{item:algorithmus15} Seien $R = \{a, b, c\}$ die roten und $B = \{x, y, z\}$ die blauen Branch-Ends des \kdd-Homöomorph.
